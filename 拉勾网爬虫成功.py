...
def get_page(num):
    ...
    headers = {
        ...
        'Referer': "https://www.lagou.com/jobs/list_pthhon?city=%E5%85%A8%E5%9B%BD&cl=false&fromSearch=true&labelWords=&suginput="
    }
    form_data = {
        'first': 'true',
        'pn': num,
    ...
    url_start = 'https://www.lagou.com/jobs/list_pthhon?city=%E5%85%A8%E5%9B%BD&cl=false&fromSearch=true&labelWords=&suginput='
